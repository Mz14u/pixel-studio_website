...
function PixelStars() {
  ...
  return (
    <>
      {stars.map((star, i) => (
        <div key={i} className="pixel-star" style={{ top: star.top, left: star.left, animationDelay: star.delay, width: i % 3 === 0 ? "6px" : "4px", height: i % 3 === 0 ? "6px" : "4px", background: i % 2 === 0 ? "var(--accent)" : "var(--primary)" }} />
      ))}
    </>
  )
}
